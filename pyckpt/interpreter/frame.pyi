...
def eval_frame_at_lasti(func_obj: FunctionType, nlocals: list[Any], stack: list[Any], is_leaf: bool, is_return: bool = ..., ret_value: Any = ..., prev_instr_offset=..., exc_states: ExceptionStates | None = ...) -> tuple[Any, ExceptionStates | None]:
